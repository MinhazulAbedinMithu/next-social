        ...
        <div className="px-3 pb-2">
          <div className="pt-1">
            <div className="mb-2 text-sm border-b">
              Lord of the Rings is my favorite film-series. One day I will make my way to New Zealand to visit the Hobbiton set!
            </div>
          </div>
          <div className="grid grid-cols-3 border-b">
            <div className="grid grid-cols-2 divide-x text-sm mb-2 text-gray-400 cursor-pointer font-medium w-100">
              <button className="flex items-center"><AiOutlineLike /> Like</button>
              <button>12</button>
            </div>
            <div className="grid grid-cols-2 divide-x text-sm mb-2 text-gray-400 cursor-pointer font-medium w-100">
              <button className="flex items-center"><BiMessageAlt /> Comment</button>
              <button>24</button>
            </div>
            <div className="grid grid-cols-2 divide-x text-sm mb-2 text-gray-400 cursor-pointer font-medium w-100">
              <button className="flex items-center"><AiOutlineShareAlt /> Share</button>
              <button>3</button>
            </div>
          </div>
          <div className="mb-2">
